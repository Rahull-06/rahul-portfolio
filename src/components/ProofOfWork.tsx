...
export default function ProofOfWork() {
    ...
    return (
        <section id="pow" ref={ref} className="px-4 sm:px-8 md:px-16 py-16 md:py-28 bg-ink2 border-t border-b border-border">
            <div className="max-w-[1240px] mx-auto">
                ...
                <div className="h-px bg-gradient-to-r from-lime to-transparent opacity-25 mb-10 md:mb-12" />

                <h2 className="font-serif text-[2.5rem] md:text-[3.5rem] font-black leading-[1.05] tracking-[-2px] reveal mb-8 md:mb-10">
                    Numbers Don&apos;t <br /><em className="text-lime">Lie.</em>
                </h2>

                {/* 1-col mobile, 2-col tablet, 4-col desktop */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px border border-border bg-border reveal d1">
                    {cards.map((c) => (
                        <div
                            key={c.label}
                            className="bg-ink2 p-6 md:p-9 flex flex-col gap-2 transition-all duration-300 hover:bg-card hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(0,0,0,0.5)]"
                        >
                            <span className="text-2xl">{c.icon}</span>
                            <div className="font-serif text-[2rem] md:text-[2.4rem] font-black text-lime leading-none">{c.val}</div>
                ...
                <div className="flex gap-3 justify-center mt-8 md:mt-10 reveal d2 flex-wrap">
                    {[
                        ...
                        <a
                            ...
                            className={`font-mono text-[0.68rem] px-5 md:px-6 py-3 border uppercase tracking-widest transition-all duration-300 hover:scale-[1.04] ${
                                l.primary
