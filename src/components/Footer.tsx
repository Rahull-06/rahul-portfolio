export default function Footer() {
    return (
        <footer className="px-16 py-6 border-t border-border flex justify-between items-center flex-wrap gap-4">
            <div className="font-mono text-[0.62rem] text-gray tracking-widest">
